...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'searchHistory.processingScore': 'Processing Score',
    'searchHistory.foundResult': 'Found Result',
    'searchHistory.searchedFor': 'Searched for',
    'searchHistory.productFound': 'Product Found',
    'searchHistory.searchType': 'Search Type',
    'searchHistory.viewStats': 'View Statistics',
    'searchHistory.emptyState.title': 'No Search History Yet',
    'searchHistory.emptyState.description': 'Start scanning or searching for products to build your search history',
    'searchHistory.emptyState.actionButton': 'Start Scanning Now',
  ...
  es: {
    ...
    // Search History
    'searchHistory.title': 'Historial de Búsquedas',
    'searchHistory.subtitle': 'Ve tus búsquedas recientes de productos e historial de análisis',
    'searchHistory.backToHome': 'Volver al Inicio',
    'searchHistory.totalSearches': 'Búsquedas Totales',
    'searchHistory.successfulSearches': 'Búsquedas Exitosas',
    'searchHistory.recentSearches': 'Búsquedas Recientes',
    'searchHistory.allTimeSearches': 'Búsquedas de todos los tiempos',
    'searchHistory.successRate': 'Tasa de éxito',
    'searchHistory.lastSevenDays': 'Últimos 7 días',
    'searchHistory.recentActivity': 'Actividad Reciente',
    'searchHistory.yourSearchHistory': 'Tu historial completo de búsquedas con resultados y análisis',
    'searchHistory.barcode': 'Código de Barras',
    'searchHistory.textSearch': 'Búsqueda de Texto',
    'searchHistory.noResultFound': 'No se encontró resultado',
    'searchHistory.noSearches': 'Aún no hay búsquedas',
    'searchHistory.startSearching': 'Comienza a escanear productos para ver tu historial de búsquedas aquí',
    'searchHistory.startFirstSearch': 'Comienza Tu Primera Búsqueda',
    'searchHistory.justNow': 'Ahora mismo',
    'searchHistory.minutesAgo': 'hace {minutes} minutos',
    'searchHistory.hoursAgo': 'hace {hours} horas',
    'searchHistory.daysAgo': 'hace {days} días',
    'searchHistory.unknown': 'Desconocido',
    'searchHistory.processingScore': 'Puntuación de Procesamiento',
    'searchHistory.foundResult': 'Resultado Encontrado',
    'searchHistory.searchedFor': 'Buscado por',
    'searchHistory.productFound': 'Producto Encontrado',
    'searchHistory.searchType': 'Tipo de Búsqueda',
    'searchHistory.viewStats': 'Ver Estadísticas',
    'searchHistory.emptyState.title': 'Aún No Hay Historial de Búsquedas',
    'searchHistory.emptyState.description': 'Comienza a escanear o buscar productos para construir tu historial de búsquedas',
    'searchHistory.emptyState.actionButton': 'Comenzar a Escanear Ahora',
    'dropdown.searchHistory': 'Historial de Búsquedas',
    ...
    'auth.login.passwordPlaceholder': 'Ingresa tu contraseña',
    'auth.login.keepLoggedIn': 'Mantenerme conectado por 30 días',
    'auth.login.forgotPassword': '¿Olvidaste tu contraseña?',
  ...
  fr: {
    ...
    'searchHistory.subtitle': 'Consultez vos recherches récentes de produits et l\'historique d\'analyse',
    'searchHistory.backToHome': 'Retour à l\'Accueil',
    'searchHistory.totalSearches': 'Recherches Totales',
    'searchHistory.successfulSearches': 'Recherches Réussies',
    'searchHistory.recentSearches': 'Recherches Récentes',
    'searchHistory.allTimeSearches': 'Toutes les recherches',
    'searchHistory.successRate': 'Taux de réussite',
    'searchHistory.lastSevenDays': '7 derniers jours',
    'searchHistory.recentActivity': 'Activité Récente',
    'searchHistory.yourSearchHistory': 'Votre historique complet de recherche avec résultats et analyses',
    'searchHistory.barcode': 'Code-barres',
    'searchHistory.textSearch': 'Recherche Textuelle',
    'searchHistory.noResultFound': 'Aucun résultat trouvé',
    'searchHistory.noSearches': 'Aucune recherche encore',
    'searchHistory.startSearching': 'Commencez à scanner des produits pour voir votre historique de recherche ici',
    'searchHistory.startFirstSearch': 'Commencer Votre Première Recherche',
    'searchHistory.justNow': 'À l\'instant',
    'searchHistory.minutesAgo': 'il y a {minutes} minutes',
    'searchHistory.hoursAgo': 'il y a {hours} heures',
    'searchHistory.daysAgo': 'il y a {days} jours',
    'searchHistory.unknown': 'Inconnu',
    'searchHistory.processingScore': 'Score de Traitement',
    'searchHistory.foundResult': 'Résultat Trouvé',
    'searchHistory.searchedFor': 'Recherché pour',
    'searchHistory.productFound': 'Produit Trouvé',
    'searchHistory.searchType': 'Type de Recherche',
    'searchHistory.viewStats': 'Voir les Statistiques',
    'searchHistory.emptyState.title': 'Aucun Historique de Recherche Encore',
    'searchHistory.emptyState.description': 'Commencez à scanner ou rechercher des produits pour construire votre historique de recherche',
    'searchHistory.emptyState.actionButton': 'Commencer à Scanner Maintenant',
    'dropdown.searchHistory': 'Historique de Recherche',
    ...
    'auth.login.keepLoggedIn': 'Me garder connecté pendant 30 jours',
  ...
  de: {
    ...
    'auth.login.keepLoggedIn': 'Für 30 Tage angemeldet bleiben',
    ...
    'searchHistory.subtitle': 'Sehen Sie Ihre aktuellen Produktsuchen und Analysehistorie',
    'searchHistory.backToHome': 'Zurück zur Startseite',
    'searchHistory.totalSearches': 'Gesamte Suchen',
    'searchHistory.successfulSearches': 'Erfolgreiche Suchen',
    'searchHistory.recentSearches': 'Aktuelle Suchen',
    'searchHistory.allTimeSearches': 'Alle Suchen',
    'searchHistory.successRate': 'Erfolgsrate',
    'searchHistory.lastSevenDays': 'Letzte 7 Tage',
    'searchHistory.recentActivity': 'Aktuelle Aktivität',
    'searchHistory.yourSearchHistory': 'Ihr vollständiger Suchverlauf mit Ergebnissen und Analysen',
    'searchHistory.barcode': 'Barcode',
    'searchHistory.textSearch': 'Textsuche',
    'searchHistory.noResultFound': 'Kein Ergebnis gefunden',
    'searchHistory.noSearches': 'Noch keine Suchen',
    'searchHistory.startSearching': 'Beginnen Sie mit dem Scannen von Produkten, um Ihren Suchverlauf hier zu sehen',
    'searchHistory.startFirstSearch': 'Erste Suche Starten',
    'searchHistory.justNow': 'Gerade eben',
    'searchHistory.minutesAgo': 'vor {minutes} Minuten',
    'searchHistory.hoursAgo': 'vor {hours} Stunden',
    'searchHistory.daysAgo': 'vor {days} Tagen',
    'searchHistory.unknown': 'Unbekannt',
    'searchHistory.processingScore': 'Verarbeitungspunktzahl',
    'searchHistory.foundResult': 'Ergebnis Gefunden',
    'searchHistory.searchedFor': 'Gesucht nach',
    'searchHistory.productFound': 'Produkt Gefunden',
    'searchHistory.searchType': 'Suchtyp',
    'searchHistory.viewStats': 'Statistiken Anzeigen',
    'searchHistory.emptyState.title': 'Noch Kein Suchverlauf',
    'searchHistory.emptyState.description': 'Beginnen Sie mit dem Scannen oder Suchen von Produkten, um Ihren Suchverlauf aufzubauen',
    'searchHistory.emptyState.actionButton': 'Jetzt Scannen Starten',
    'dropdown.searchHistory': 'Suchverlauf',
  ...
  zh: {
    ...
    'searchHistory.subtitle': '查看您最近的产品搜索和分析历史',
    'searchHistory.backToHome': '返回首页',
    'searchHistory.totalSearches': '总搜索次数',
    'searchHistory.successfulSearches': '成功搜索',
    'searchHistory.recentSearches': '最近搜索',
    'searchHistory.allTimeSearches': '所有时间搜索',
    'searchHistory.successRate': '成功率',
    'searchHistory.lastSevenDays': '最近7天',
    'searchHistory.recentActivity': '最近活动',
    'searchHistory.yourSearchHistory': '您的完整搜索历史与结果和分析',
    'searchHistory.barcode': '条形码',
    'searchHistory.textSearch': '文本搜索',
    'searchHistory.noResultFound': '未找到结果',
    'searchHistory.noSearches': '还没有搜索',
    'searchHistory.startSearching': '开始扫描产品以在此处查看您的搜索历史',
    'searchHistory.startFirstSearch': '开始您的首次搜索',
    'searchHistory.justNow': '刚刚',
    'searchHistory.minutesAgo': '{minutes}分钟前',
    'searchHistory.hoursAgo': '{hours}小时前',
    'searchHistory.daysAgo': '{days}天前',
    'searchHistory.unknown': '未知',
    'searchHistory.processingScore': '加工评分',
    'searchHistory.foundResult': '找到结果',
    'searchHistory.searchedFor': '搜索了',
    'searchHistory.productFound': '找到产品',
    'searchHistory.searchType': '搜索类型',
    'searchHistory.viewStats': '查看统计',
    'searchHistory.emptyState.title': '还没有搜索历史',
    'searchHistory.emptyState.description': '开始扫描或搜索产品以建立您的搜索历史',
    'searchHistory.emptyState.actionButton': '立即开始扫描',
    'dropdown.searchHistory': '搜索历史',
    ...
    'auth.login.keepLoggedIn': '保持登录30天',
  ...
  ja: {
    ...
    'searchHistory.subtitle': '最近の製品検索と分析履歴を表示',
    'searchHistory.backToHome': 'ホームに戻る',
    'searchHistory.totalSearches': '総検索数',
    'searchHistory.successfulSearches': '成功した検索',
    'searchHistory.recentSearches': '最近の検索',
    'searchHistory.allTimeSearches': '全期間の検索',
    'searchHistory.successRate': '成功率',
    'searchHistory.lastSevenDays': '過去7日間',
    'searchHistory.recentActivity': '最近のアクティビティ',
    'searchHistory.yourSearchHistory': '結果と分析を含む完全な検索履歴',
    'searchHistory.barcode': 'バーコード',
    'searchHistory.textSearch': 'テキスト検索',
    'searchHistory.noResultFound': '結果が見つかりません',
    'searchHistory.noSearches': 'まだ検索がありません',
    'searchHistory.startSearching': '製品のスキャンを開始して、検索履歴をここに表示してください',
    'searchHistory.startFirstSearch': '最初の検索を開始',
    'searchHistory.justNow': 'たった今',
    'searchHistory.minutesAgo': '{minutes}分前',
    'searchHistory.hoursAgo': '{hours}時間前',
    'searchHistory.daysAgo': '{days}日前',
    'searchHistory.unknown': '不明',
    'searchHistory.processingScore': '加工スコア',
    'searchHistory.foundResult': '結果が見つかりました',
    'searchHistory.searchedFor': '検索対象',
    'searchHistory.productFound': '製品が見つかりました',
    'searchHistory.searchType': '検索タイプ',
    'searchHistory.viewStats': '統計を表示',
    'searchHistory.emptyState.title': 'まだ検索履歴がありません',
    'searchHistory.emptyState.description': '製品のスキャンまたは検索を開始して検索履歴を構築してください',
    'searchHistory.emptyState.actionButton': '今すぐスキャンを開始',
    'dropdown.searchHistory': '検索履歴',
    ...
    'auth.login.keepLoggedIn': '30日間ログイン状態を保持',
  ...
  nl: {
    ...
    'auth.login.keepLoggedIn': 'Blijf 30 dagen ingelogd',
