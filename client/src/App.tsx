  ...
  return (
    <Layout onStartTutorial={handleStartTutorial}>
      ...
      <Switch>
        ...
        <Route path="/user/:id" component={PublicUserProfile} />
        <Route path="/leveling" component={LevelingPage} />
        <Route path="/levels" component={LevelingPage} />
        ...
        <Route path="/nutri-dashboard/releases" component={Releases} />
