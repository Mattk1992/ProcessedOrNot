        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/nutri-dashboard/profile" className="text-foreground font-medium">Profile</Link>
            </nav>
                  ...
                  <Form {...weightForm}>
                    <form onSubmit={weightForm.handleSubmit(onSubmitWeight)} className="space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Muscle Mass kg (optional)</FormLabel>
                            <FormControl>
                              <Input 
                                type="number" 
                                step="0.1"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea placeholder="Any notes about this entry..." {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <div className="flex justify-end space-x-2">
                        ...
                        <Button type="submit" disabled={addWeightMutation.isPending}>
                          {addWeightMutation.isPending ? "Recording..." : "Record Weight"}
                        </Button>
                      </div>
                    </form>
                  </Form>
